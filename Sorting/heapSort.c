...
// yo chaii maile git bash ma aafno gitpush garna lai long command code bhako bhayera maile short cut 
// banauna ko laagi just a sample piece or formula ho bhanam na..
